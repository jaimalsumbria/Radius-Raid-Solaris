...
$.Bullet.prototype.render = function( i ) {
	if( this.inView ) {
		...
		var direction = Math.atan2(this.y - this.ey, this.x - this.ex );
		
		$.ctxmg.save();
		$.ctxmg.translate( this.x, this.y );
		$.ctxmg.rotate( direction  + $.pi / 2);
		$.ctxmg.globalAlpha = 0.9;
		$.ctxmg.drawImage($.bullet, 0-(this.lineWidth*5/2), 0, this.lineWidth*5, this.lineWidth*5);
		$.ctxmg.globalAlpha = 1;
		$.ctxmg.restore();
