...
$.util.arcIntersectingArc = function( x1, y1, r1, x2, y2, r2) {
...
$.util.fillRect = function( ctx, x, y, width, height, fillStyle ) {  
    ctx.fillStyle = fillStyle;
	ctx.fillRect( x, y, width, height );
};

$.util.strokeRect = function( ctx, x, y, width, height, strokeStyle, lineWidth ) {  
    ctx.strokeStyle = strokeStyle;
	ctx.lineWidth = lineWidth;
